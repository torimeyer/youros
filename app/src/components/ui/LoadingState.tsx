  ...
  return (
    <div className="flex flex-col gap-3 py-4">
      {Array.from({ length: 5 }).map((_, i) => (
        <div key={i} className="flex items-center gap-3 p-4 bg-slate-900/40 border border-slate-800 rounded-xl">
...
function SkeletonCardVariant() {
  return (
    <div className="p-5 bg-slate-900/40 border border-slate-800 rounded-xl flex flex-col gap-3">
