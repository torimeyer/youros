    ...
    >
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 bg-slate-800 border border-slate-700 rounded-lg px-3 py-1.5 text-xs text-slate-200 placeholder-slate-500 outline-none focus:border-blue-500/50 min-w-0"
        />
        <button
          onClick={submit}
          disabled={!value.trim()}
          data-testid="inline-text-prompt-submit"
          className="px-3 py-1.5 rounded-lg bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/40 text-blue-300 text-xs font-medium transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
        >
