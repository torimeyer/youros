      ...
      >
        ...
        <div className="overflow-y-auto flex-1 px-5 py-4 space-y-3">
          ...
          {subtab === 'tasks' && (
            <>
              {tasksLoading && (
                <div className="text-sm text-slate-600 dark:text-slate-400 py-8 text-center">Loading tasks...</div>
              )}
              {tasksError && (
                <div className="text-sm text-red-400 bg-red-500/10 rounded-lg px-4 py-3">{tasksError}</div>
              )}
              {tasks && tasks.length === 0 && (
                <div className="text-sm text-slate-600 dark:text-slate-400 py-8 text-center">No open tasks.</div>
              )}
              {tasks && tasks.map((t) => {
          ...
          {subtab === 'waves' && (
            <div className="relative">
              ...
              {wavesData && wavesData.waves.length === 0 && (
                <div className="text-sm text-slate-600 dark:text-slate-400 py-8 text-center">No open tasks to plan.</div>
              )}
