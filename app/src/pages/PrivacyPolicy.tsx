  ...
  const sections: Section[] = [
      ...
      body: (
        <>
          <p className="text-sm text-slate-400 mb-3">
            ...
            <code className="text-slate-300 bg-slate-800 px-1 rounded">~/.myos/</code> on your
          ...
          <ul className="text-sm text-slate-400 space-y-2 list-disc list-inside">
            ...
            <li>
              ...
              <code className="text-slate-300 bg-slate-800 px-1 rounded">~/.myos/</code> and are
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <ul className="text-sm text-slate-400 space-y-2 list-disc list-inside">
            <li>
              <strong className="text-slate-300">AI providers.</strong> When you send a message or
            ...
            <li>
              <strong className="text-slate-300">Connected services.</strong> If you link Google,
    ...
    },
    {
      ...
      body: (
        <ul className="text-sm text-slate-400 space-y-2 list-disc list-inside">
          <li>
            <strong className="text-slate-300">Delete everything.</strong> Remove{' '}
            <code className="text-slate-300 bg-slate-800 px-1 rounded">~/.myos/</code> to wipe all
            local data. The app will start fresh on next launch.
          </li>
          <li>
            <strong className="text-slate-300">Delete specific data.</strong> Remove individual
            files inside{' '}
            <code className="text-slate-300 bg-slate-800 px-1 rounded">~/.myos/</code> (for
            example,{' '}
            <code className="text-slate-300 bg-slate-800 px-1 rounded">chat_history.json</code>)
            to clear just that data.
          </li>
          <li>
            <strong className="text-slate-300">Reset onboarding.</strong> Go to Settings to clear
            your profile and run the setup wizard again.
          </li>
          <li>
            <strong className="text-slate-300">Revoke shared links.</strong> Go to Settings and
            find the Shares section. You can revoke any shared link at any time.
          </li>
          <li>
            <strong className="text-slate-300">Disconnect services.</strong> Revoke OAuth tokens in
            your Google, Slack, or GitHub account settings. Deleting the token files inside{' '}
            <code className="text-slate-300 bg-slate-800 px-1 rounded">~/.myos/</code> also severs
