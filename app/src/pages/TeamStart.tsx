    ...
    <div className="max-w-lg mx-auto pt-16 px-6">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 rounded-full bg-indigo-500/20 flex items-center justify-center">
            <Icon name="groups" className="text-indigo-400 text-xl" />
          </div>
      ...
      <div className="mb-6">
        <OrgNameStep
          ...
          inputCls="bg-slate-800 border-slate-700 text-white placeholder-slate-500"
      ...
      <div className="flex gap-3">
        <button
          onClick={() => navigate(-1)}
          className="px-5 py-2.5 rounded-lg border border-slate-700 text-slate-300 hover:bg-slate-800 transition-colors text-sm"
        >
          Cancel
        </button>
        <button
