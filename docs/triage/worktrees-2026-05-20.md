...
**Cherry-picked:** 2  
**Needles filed:** 3 (→1540, →1541, →1542)

---

## Cherry-picks landed (commit on this branch)

| Commit | Worktree | Needle | What it does |
|--------|----------|--------|--------------|
...
| Worktree | Needle | Files | Classification | Reason |
|----------|--------|-------|----------------|--------|
...
| Worktree | Needle | Classification | Reason |
|----------|--------|----------------|--------|
...
| agent-diagnose-jira-adf-ren-4ab2d025 | →1443 | **conflict** (→1542) | Jira ADF rendering not found in main. Same situation as →1444 — lives inside atlassian-site-split branch. Bundled into needle →1542. |
...
| `fix-NNNN-*` | ~35 | Mix — cross-check each against main's git log for the needle number |
| `cherry-pick-*` | ~10 | Likely superseded — the cherry-pick was the point |
| `build-NNNN-*` | ~15 | Mix — check if needle was closed |
