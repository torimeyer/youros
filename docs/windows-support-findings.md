...
Full native Windows support for yourOS dev scripts would take 2–4 weeks. WSL2-first takes 1–2 days (this doc + runtime fixes). Windows users run the yourOS web app under WSL2, get all app features, and the dev environment is documented as WSL2-only for now.

## What works on Windows today (after this PR)

- yourOS web app (frontend — no changes needed)
