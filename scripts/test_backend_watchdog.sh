...
YOUROS_WATCHDOG_HEALTH_URL="http://127.0.0.1:${DEAD_PORT}/api/health" \
YOUROS_WATCHDOG_BACKEND_PORT="$DEAD_PORT" \
YOUROS_WATCHDOG_PIDFILE="$WD_PIDFILE" \
YOUROS_WATCHDOG_LOGFILE="$WD_LOG" \
YOUROS_WATCHDOG_RESTART_WAIT=1 \
YOUROS_WATCHDOG_MAX_RESTARTS=2 \
...
YOUROS_WATCHDOG_INTERVAL=1 \
YOUROS_WATCHDOG_HEALTH_URL="http://127.0.0.1:${LIVE_PORT}/" \
YOUROS_WATCHDOG_BACKEND_PORT="$LIVE_PORT" \
YOUROS_WATCHDOG_PIDFILE="$WORKDIR/watchdog2.pid" \
YOUROS_WATCHDOG_LOGFILE="$WORKDIR/watchdog2.log" \
YOUROS_WATCHDOG_MAX_RESTARTS=5 \
YOUROS_NO_WATCHDOG=1 \
bash "$WORKDIR/scripts/backend_watchdog.sh" >/dev/null 2>&1 &
WD_PID2=$!
...
YOUROS_WATCHDOG_INTERVAL=1 \
YOUROS_WATCHDOG_HEALTH_URL="http://127.0.0.1:${DEAD_PORT}/api/health" \
YOUROS_WATCHDOG_BACKEND_PORT="$DEADLOCK_PORT" \
YOUROS_WATCHDOG_PIDFILE="$WORKDIR/watchdog3.pid" \
YOUROS_WATCHDOG_LOGFILE="$WORKDIR/watchdog3.log" \
YOUROS_WATCHDOG_DEADLOCK_THRESHOLD=2 \
YOUROS_WATCHDOG_RESTART_WAIT=1 \
YOUROS_WATCHDOG_MAX_RESTARTS=5 \
YOUROS_NO_WATCHDOG=1 \
bash "$WORKDIR/scripts/backend_watchdog.sh" >/dev/null 2>&1 &
...
YOUROS_WATCHDOG_INTERVAL=1 \
YOUROS_WATCHDOG_HEALTH_URL="http://127.0.0.1:${DEAD_PORT}/api/health" \
YOUROS_WATCHDOG_BACKEND_PORT="$PYSPY_PORT" \
YOUROS_WATCHDOG_PIDFILE="$WORKDIR/watchdog4.pid" \
YOUROS_WATCHDOG_LOGFILE="$WORKDIR/watchdog4.log" \
YOUROS_WATCHDOG_DEADLOCK_THRESHOLD=2 \
YOUROS_WATCHDOG_RESTART_WAIT=1 \
YOUROS_WATCHDOG_PYSPY_TIMEOUT=5 \
YOUROS_WATCHDOG_MAX_RESTARTS=3 \
YOUROS_NO_WATCHDOG=1 \
bash "$WORKDIR/scripts/backend_watchdog.sh" >/dev/null 2>&1 &
WD_PID6=$!
...
YOUROS_WATCHDOG_INTERVAL=1 \
YOUROS_WATCHDOG_HEALTH_URL="http://127.0.0.1:${DEAD_PORT}/api/health" \
YOUROS_WATCHDOG_BACKEND_PORT="$NOPYSPY_PORT" \
YOUROS_WATCHDOG_PIDFILE="$WORKDIR/watchdog5.pid" \
YOUROS_WATCHDOG_LOGFILE="$WORKDIR/watchdog5.log" \
YOUROS_WATCHDOG_DEADLOCK_THRESHOLD=2 \
YOUROS_WATCHDOG_RESTART_WAIT=1 \
YOUROS_WATCHDOG_MAX_RESTARTS=3 \
YOUROS_NO_WATCHDOG=1 \
...
# --- Test 8: YOUROS_WATCHDOG_PYSPY_TIMEOUT is respected ---
...
YOUROS_WATCHDOG_INTERVAL=1 \
YOUROS_WATCHDOG_HEALTH_URL="http://127.0.0.1:${DEAD_PORT}/api/health" \
YOUROS_WATCHDOG_BACKEND_PORT="$TIMEOUT_PORT" \
YOUROS_WATCHDOG_PIDFILE="$WORKDIR/watchdog6.pid" \
YOUROS_WATCHDOG_LOGFILE="$WORKDIR/watchdog6.log" \
YOUROS_WATCHDOG_DEADLOCK_THRESHOLD=2 \
YOUROS_WATCHDOG_PYSPY_TIMEOUT=2 \
YOUROS_WATCHDOG_RESTART_WAIT=1 \
YOUROS_WATCHDOG_MAX_RESTARTS=3 \
YOUROS_NO_WATCHDOG=1 \
bash "$WORKDIR/scripts/backend_watchdog.sh" >/dev/null 2>&1 &
